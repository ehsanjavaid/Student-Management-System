...
from student import Student  # ✅ Create Student directly
...
class StudentApp:
    def __init__(self, root):
        ...
        tk.Label(input_frame, text="Name:", font=("Arial", 12), bg="#f4f4f4").grid(row=0, column=0, padx=5, pady=5)
        tk.Label(input_frame, text="Age:", font=("Arial", 12), bg="#f4f4f4").grid(row=1, column=0, padx=5, pady=5)
        tk.Label(input_frame, text="Marks:", font=("Arial", 12), bg="#f4f4f4").grid(row=2, column=0, padx=5, pady=5)
        ...
        self.tree = ttk.Treeview(root, columns=("Name", "Age", "Marks"), show="headings")
    ...
    # If no list passed, keep table empty
        if students_list:
